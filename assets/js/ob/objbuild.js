...
// Get the JSON file
$.get('static/js/ob/verbs.json', function(verb_obj) {
...
$("#add").on("click", function() {
	...
	$("#compList").append(
		"<li id='"
		+ current_index
		+ "'><p class='finCon'>Given , will .</p><div class='objButtons'><a href='#' class='edit'><img src='static/img/ob/pencil.png' alt='edit' title='edit' class='pencil'></a><a href='#' class='delete'><img src='static/img/ob/close.png' alt='delete' title='delete' class='close'></a></div></li>");
...
function getDefinitions(){
	var level_def;
	$.getJSON("static/js/ob/verbs.json", function(data){
		var index1;
		var index2;
		index1 = $("#domain").val();
		index2 = $("#level").val();
